...
def info(username):
    # 个人信息
    return send_file('templates/about2.html')


@app.route('/<username>/my_info')
def my_info(username):
    # 个人信息
    return send_file('templates/my_info.html')
...
@app.route('/<username>/good/release')
def topic_release(username):
    # 发表博客
    return send_file('templates/release2.html')

@app.route('/<goodname>/list')
def list(goodname):
    # 商品信息列表
